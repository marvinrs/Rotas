...
<html>
  <head>
    <title>Mostra a Melhor Rota</title>

    <?php
      $endereco_inicial=str_replace(" ", "", "Avenida Dr. Gastão Vidigal, 1132 - Vila Leopoldina")
      $endereco_thiago=$_GET["endereco"];
      $endereco_fernando=$_GET["endereco"];
      $endereco_marcelo=$_GET["endereco"];
      $endereco_andre=$_GET["endereco"];
